...
function Info($m) { Write-Host "[v19-copy] $m" -ForegroundColor Cyan }
function Warn($m) { Write-Host "[v19-copy][WARN] $m" -ForegroundColor Yellow }
...
# MSVC runtime DLLs from Build Tools / VS, if present.
$vsRoots = @(
