...
$BackupRoot = Join-Path $Root ".jnn_patch_backups\fast_recovery_v78b_safe_$Stamp"
...
$RestoreScript = Join-Path $PatchDir 'restore_latest_fast_recovery_v78b_safe_backup.ps1'
$RestoreContent = @'
$ErrorActionPreference = 'Stop'
...
Write-Host "Applied fast recovery v78b safe patch. Backup: $BackupRoot"
