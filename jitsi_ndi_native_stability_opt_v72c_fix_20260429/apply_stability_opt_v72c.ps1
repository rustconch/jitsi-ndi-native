...
# v72c fixes repo-root detection and uses absolute paths for .NET file IO.

$ErrorActionPreference = "Stop"

function Write-Step($msg) { Write-Host "[v72c] $msg" }
...
$backupRoot = Join-Path $repo ".jnn_patch_backups\stability_opt_v72c_$stamp"
