...
public:
    ...
    bool refreshReceiverSubscriptions(const std::string& reason);
    ...
    std::uint64_t recoveryHints() const { return recoveryHints_; }
...
private:
    ...
    std::atomic<std::uint64_t> recoveryHints_{0};
};
