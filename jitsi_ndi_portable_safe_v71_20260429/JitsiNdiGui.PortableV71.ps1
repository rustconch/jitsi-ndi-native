# Jitsi NDI Native GUI v71 portable safe - no watchdog, hidden runner logging
# ASCII-only PowerShell script to avoid codepage/parser issues.
# Portable v71: no watchdog/autorestart; native runs via hidden runner and writes native log file.
...
'# native log redirected by portable GUI v71' | Out-File -LiteralPath $(Quote-PsString $script:nativeLogFile) -Encoding utf8
